                                    ...
                                    <tr key={user.id} className="border-t hover:bg-gray-50">
                                        ...
                                        <td className="p-2 sm:p-3 text-xs sm:text-sm">
                                            <select
                                                ...
                                                className="p-1 border border-gray-300 rounded text-xs focus:outline-none focus:ring-2 focus:ring-blue-500"
                                            >
                                        ...
                                        <td className="p-2 sm:p-3">
                                            <button
                                                ...
                                                className={`px-2 sm:px-3 py-1 rounded text-white text-xs sm:text-sm font-semibold transition ${
                                                    user.isActive 
